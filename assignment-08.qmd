...
3. `if()` the student went to college, add a second sentence that says how many months they had between high school and going to college
4. Optional: Following from that, edit the second sentence to include how that student's delay compares to the average delay (you can pick, mean or median)
